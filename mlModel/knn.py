...
X = [list(map(float, row[1:-1])) for row in features]  # Features (excluding Function Name and Best Opt Passes)
...
knn_model = KNeighborsRegressor(n_neighbors=k, metric='euclidean')  # Use 'euclidean' distance by default
