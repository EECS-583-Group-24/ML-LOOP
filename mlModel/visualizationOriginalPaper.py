...
plt.savefig('../figures/originalPaper/Min_Max_Models_Improvement_O3.png', bbox_inches='tight')
plt.close()
with open('../figures/originalPaper/Min_Max_Models_Improvement_O3.md', 'w') as md_file:
...
plt.legend(loc='center left', bbox_to_anchor=(1.0, 0.5))
plt.gca().yaxis.set_minor_locator(mtick.AutoMinorLocator())
plt.savefig('../figures/originalPaper/TestFiles_Improvement_O3.png', bbox_inches='tight')
plt.close()
with open('../figures/originalPaper/TestFiles_Improvement_O3.md', 'w') as md_file:
    md_file.write(df_improvement.to_markdown())
